...
public class Notes
{
    public static void ifExample()
    {
         ...
         *      is true.
         *  Conditional expressions evaluate to either true of false.
         *  The conditional expression must go inside of parentheses.
         *  Statements are groued by blocks (i.e., { }), not by
        ...
        /*
         * if-else statement
         *  The else block is executed if the condition evaluates
         *      to false.
         */
        if(coinFlip == 1)
        {
    ...
    public static void stringExample()
    {
         ...
         *      equals means is defined by class. For Strings,
         ...
         *      0:          if the strings are equal (same sequence
         *                      of characters)
         ...
         *      If the left operand is true, the right operand
         *      will not be evaluated because the OR operation
         *      is already true.
         *  
         *  This may result in a bug. If the first word entered is
         *      "kiwi", we will never read the second word from the
         *      stream, which may result in unexpected behavior.
         */
    ...
    public static String getStudentClass(int gradeNumber)
    {
         ...
         * switch statement
         *  
         *  This is another conditional decision statement (Like
         *      an if statement). It is preferred when evaluating
         *      several *discrete* values. It supports byte, short,
         *      char, and int primitive types. It also supports
         *      enumerations and String objects.
         *    
         *  The condition is evaluated and then the flow of
         *      execution jumps to the case that matches.
         */
        String studentClass = "";
    ...
    public static void extraOperatorsExample()
    {
         ...
         *  Perform the specified mathematical operation to the
         *      variable and then assign the resulting value to
         *      the same variable.
         */
        int x = 7;
        int y = 7;
         ...
         *      These are equivalent to adding/subtracting 1 from
         *          the variable.
         *      These return the value before performing the
         *          increment/decrement.
         */
        int a = 7;
        int b = a++;
         ...
         *      These return the value after performing the
         *          increment/decrement.
         */
        int c = 7;
        int d = ++c;
